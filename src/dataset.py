...
class Synth90kDataset(Dataset):
    ...
    def _load_from_raw_files(self, root_dir, mode):
        mapping = {}
        with open('E:\\Doctor-Prescripton-Handwritten-Recoginition-main\\data\\mnt\\ramdisk\\max\\90kDICT32px\\lexicon.txt', 'r') as fr:
        ...
        paths = []
        texts = []
        with open('E:\\Doctor-Prescripton-Handwritten-Recoginition-main\\data\\mnt\\ramdisk\\max\\90kDICT32px\\annotation.txt', 'r') as fr:
